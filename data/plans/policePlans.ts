...
export const getPoliceResponsePlan = (id: number): IResponsePlan | undefined => {
  return policePlans.find((plan) => plan.id === id);
}

export const getPoliceResponsePlanFromProtocol = (protocol: number, priority: string, code: string): IResponsePlan | undefined => {
